...
**What it indicates:** In the 'video' module, a `TimeoutError` was raised. Reason: Video Control card is still not visible after relaunching app
...
**What it indicates:** In the 'bluetooth' module, a `RuntimeError` was raised. Reason: Bluetooth device list did not populate within timeout
...
**What it indicates:** In the 'display' module, a `ElementNotVisibleException` was raised. Reason: Display Settings panel not found after app restart
...
**What it indicates:** In the 'keyboard' module, a `Failed` was raised. Reason: Cannot proceed without keyboard page access: Keyboard backlight card not visible after retries
...
**What it indicates:** In the 'camera' module, a `ElementNotInteractableException` was raised. Reason: Camera privacy toggle element not interactable
...
**What it indicates:** In the 'battery' module, a `ValueError` was raised. Reason: Battery health widget failed to load data
...
**What it indicates:** In the 'network' module, a `AttributeError` was raised. Reason: WiFi status element returned None after multiple attempts
...
**Typical fix direction:** An object in 'network' does not have the attribute 'the referenced attribute'. This typically means an API/interface change, a None return where an object was expected, or a wrong import. Verify object types and the API contract.
...
**What it indicates:** In the 'touchpad' module, a `RenderingError` was raised. Reason: Touchpad sensitivity slider not rendered correctly
...
**What it indicates:** In the 'speaker' module, a `NoSuchElementException` was raised. Reason: Speaker volume control not found in DOM
...
**What it indicates:** In the 'microphone' module, a `TimeoutException` was raised. Reason: Microphone gain settings response timed out
...
**What it indicates:** In the 'storage' module, a `IOError` was raised. Reason: Storage health indicator fetch returned empty response
...
**What it indicates:** In the 'updates' module, a `LookupError` was raised. Reason: Firmware update notification banner did not appear
...
**What it indicates:** In the 'performance' module, a `PermissionError` was raised. Reason: CPU performance mode toggle threw unexpected exception
...
**What it indicates:** In the 'smartsense' module, a `FeatureFlagError` was raised. Reason: SmartSense auto-optimization feature flag not enabled
...
**What it indicates:** In the 'privacy' module, a `NullPointerException` was raised. Reason: Privacy dashboard component raised NullPointerException
...
**What it indicates:** In the 'notifications' module, a `DataIntegrityError` was raised. Reason: Notification badge count mismatch detected during setup
...
**What it indicates:** In the 'health' module, a `MemoryError` was raised. Reason: System health report generation raised MemoryError
...
**What it indicates:** In the 'gestures' module, a `KeyError` was raised. Reason: Gesture shortcut registry lookup failed with KeyError
...
**What it indicates:** In the 'smartnoise' module, a `InitializationError` was raised. Reason: Smart noise cancellation model failed to initialize
...
**What it indicates:** In the 'accessibility' module, a `PermissionDeniedError` was raised. Reason: High contrast mode activation failed due to OS-level permission denial
...
**What it indicates:** In the 'sync' module, a `ConnectionRefusedError` was raised. Reason: Device sync service returned ConnectionRefusedError
...
**What it indicates:** In the 'diagnostics' module, a `CalledProcessError` was raised. Reason: Diagnostics scan initiation threw subprocess.CalledProcessError
...
**What it indicates:** In the 'settings' module, a `SchemaValidationError` was raised. Reason: App settings preferences schema validation failed
...
**What it indicates:** In the 'analytics' module, a `Failed` was raised. Reason: myXYZ analytics service did not initialize successfully
...
**What it indicates:** In the 'themes' module, a `Failed` was raised. Reason: myXYZ themes engine did not initialize successfully
